 ...
 */
extern void IMP_CreateDriverNavigationEncode(void);

/**
 *  @brief Delete the navigation encode driver.
 */
extern void IMP_DeleteDriverNavigationEncode(void);
 ...
 */
extern void IMP_OutputDriverNavigationEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, uint8_t* representation, uint8_t* availability, double* state);
