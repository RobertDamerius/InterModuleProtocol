#include "IMP_DriverGuidanceDecode.h"
#include <InterModuleProtocol.hpp>
#include <cstring>


void IMP_CreateDriverGuidanceDecode(void){}

void IMP_DeleteDriverGuidanceDecode(void){}

void IMP_OutputDriverGuidanceDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, uint8_t* representation, uint8_t* availability, double* state){
    *timestamp = 0.0;
