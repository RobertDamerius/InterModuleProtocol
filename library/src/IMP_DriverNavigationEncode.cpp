#include "IMP_DriverNavigationEncode.h"
...
void IMP_CreateDriverNavigationEncode(void){}

void IMP_DeleteDriverNavigationEncode(void){}

void IMP_OutputDriverNavigationEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, uint8_t* representation, uint8_t* availability, double* state){
