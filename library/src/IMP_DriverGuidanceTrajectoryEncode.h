 ...
 */
extern void IMP_CreateDriverGuidanceTrajectoryEncode(void);

/**
 *  @brief Delete the guidance trajectory encode driver.
 */
extern void IMP_DeleteDriverGuidanceTrajectoryEncode(void);
