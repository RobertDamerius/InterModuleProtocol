/**
 * SFunctionIMPDriverGuidanceTrajectoryDecode.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void IMP_OutputDriverGuidanceTrajectoryDecode(uint8 u1[], uint32 u2, int32 y1[1], double y2[1], int32 y3[1], int32 y4[1], int32 y5[1], double y6[1], double y7[1], uint8 y8[11], uint8 y9[13], double y10[32*p1], uint32 p1, uint32 y11[1])
 *
...
#define S_FUNCTION_NAME  SFunctionIMPDriverGuidanceTrajectoryDecode
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y10Width = 32*(int_T)mxGetScalar(ssGetSFcnParam(S, 0));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "IMP_CreateDriverGuidanceTrajectoryDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_OutputDriverGuidanceTrajectoryDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_DeleteDriverGuidanceTrajectoryDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_CreateDriverGuidanceTrajectoryDecode_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_OutputDriverGuidanceTrajectoryDecode_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_DeleteDriverGuidanceTrajectoryDecode_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    IMP_CreateDriverGuidanceTrajectoryDecode();
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T* y8 = (uint8_T*) ssGetOutputPortSignal(S, 7);
    ...
    uint32_T* y11 = (uint32_T*) ssGetOutputPortSignal(S, 10);


    /* Call the legacy code function */
    IMP_OutputDriverGuidanceTrajectoryDecode(u1, *u2, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, *p1, y11);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    IMP_DeleteDriverGuidanceTrajectoryDecode();
}
