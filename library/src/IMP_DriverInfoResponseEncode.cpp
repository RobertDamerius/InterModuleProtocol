...
void IMP_CreateDriverInfoResponseEncode(void){}

void IMP_DeleteDriverInfoResponseEncode(void){}

void IMP_OutputDriverInfoResponseEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, double* dimension, double* offset, uint8_t* textVehicleName, uint32_t textVehicleNameLength, uint8_t* textDescription, uint32_t textDescriptionLength, uint32_t maxTextLength){
