 ...
 */
extern void IMP_CreateDriverGuidanceDecode(void);

/**
 *  @brief Delete the guidance decode driver.
 */
extern void IMP_DeleteDriverGuidanceDecode(void);
 ...
 */
extern void IMP_OutputDriverGuidanceDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, uint8_t* representation, uint8_t* availability, double* state);
