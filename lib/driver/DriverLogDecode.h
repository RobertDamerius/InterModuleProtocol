 ...
 */
extern void CreateDriverLogDecode(void);

/**
 *  @brief Delete the log decode driver.
 */
extern void DeleteDriverLogDecode(void);
 ...
 */
extern void OutputDriverLogDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, uint8_t* color, uint8_t* text, uint32_t maxTextLength);
