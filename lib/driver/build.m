...
def.OutputFcnSpec = 'void OutputDriverInfoRequestDecode(uint8 u1[8], uint32 u2, int32 y1[1], double y2[1])';
...
def.OutputFcnSpec = 'void OutputDriverGuidanceTrajectoryEncode(uint8 y1[p1], uint32 y2[1], uint32 p1, double u1, int32 u2, int32 u3, int32 u4, double u5, double u6, uint8 u7[11], uint8 u8[13], double u9[32*p2], uint32 p2)';
