 ...
 */
extern void CreateDriverConvexPolygonEncode(void);

/**
 *  @brief Delete the convex polygon encode driver.
 */
extern void DeleteDriverConvexPolygonEncode(void);
