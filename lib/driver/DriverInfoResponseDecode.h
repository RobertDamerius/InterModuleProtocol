 ...
 */
extern void CreateDriverInfoResponseDecode(void);

/**
 *  @brief Delete the info response decode driver.
 */
extern void DeleteDriverInfoResponseDecode(void);
 ...
 */
extern void OutputDriverInfoResponseDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, double* dimension, double* offset, uint8_t* textVehicleName, uint8_t* textDescription, uint32_t maxTextLength);
