 ...
 */
extern void CreateDriverGuidanceEncode(void);

/**
 *  @brief Delete the guidance encode driver.
 */
extern void DeleteDriverGuidanceEncode(void);
 ...
 */
extern void OutputDriverGuidanceEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, uint8_t* representation, uint8_t* availability, double* state);
