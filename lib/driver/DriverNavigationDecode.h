 ...
 */
extern void CreateDriverNavigationDecode(void);

/**
 *  @brief Delete the navigation decode driver.
 */
extern void DeleteDriverNavigationDecode(void);
 ...
 */
extern void OutputDriverNavigationDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, uint8_t* representation, uint8_t* availability, double* state);
