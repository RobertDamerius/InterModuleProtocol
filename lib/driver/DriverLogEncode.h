 ...
 */
extern void CreateDriverLogEncode(void);

/**
 *  @brief Delete the log encode driver.
 */
extern void DeleteDriverLogEncode(void);
 ...
 */
extern void OutputDriverLogEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, uint8_t* color, uint8_t* text, uint32_t maxTextLength, uint32_t textLength);
