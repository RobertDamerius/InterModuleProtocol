#include "DriverNavigationDecode.h"
#include <InterModuleProtocol.hpp>
#include <cstring>


void CreateDriverNavigationDecode(void){}

void DeleteDriverNavigationDecode(void){}

void OutputDriverNavigationDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp, uint8_t* representation, uint8_t* availability, double* state){
    *timestamp = 0.0;
