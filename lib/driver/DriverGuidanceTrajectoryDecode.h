 ...
 */
extern void CreateDriverGuidanceTrajectoryDecode(void);

/**
 *  @brief Delete the guidance decode driver.
 */
extern void DeleteDriverGuidanceTrajectoryDecode(void);
