 ...
 */
extern void CreateDriverInfoResponseEncode(void);

/**
 *  @brief Delete the info response encode driver.
 */
extern void DeleteDriverInfoResponseEncode(void);
 ...
 */
extern void OutputDriverInfoResponseEncode(uint8_t* bytes, uint32_t* length, uint32_t maxNumBytes, double timestamp, double* dimension, double* offset, uint8_t* textVehicleName, uint32_t textVehicleNameLength, uint8_t* textDescription, uint32_t textDescriptionLength, uint32_t maxTextLength);
