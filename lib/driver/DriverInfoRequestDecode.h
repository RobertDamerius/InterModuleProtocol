 ...
 */
extern void CreateDriverInfoRequestDecode(void);

/**
 *  @brief Delete the info request decode driver.
 */
extern void DeleteDriverInfoRequestDecode(void);
 ...
 */
extern void OutputDriverInfoRequestDecode(uint8_t* bytes, uint32_t length, int32_t* numDecodedBytes, double* timestamp);
