/**
 * SFunctionIMPDriverInfoResponseDecode.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void IMP_OutputDriverInfoResponseDecode(uint8 u1[], uint32 u2, int32 y1[1], double y2[1], double y3[3], double y4[3], uint8 y5[p1], uint8 y6[p1], uint32 p1)
 *
 *    Simulink version           : 10.6 (R2022b) 13-May-2022
 *    C++ source code generated on : 27-Oct-2022 13:37:22
 *
...
#define S_FUNCTION_NAME  SFunctionIMPDriverInfoResponseDecode
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y5Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y5Width!=DYNAMICALLY_SIZED && y5Width < 1) { ssSetErrorStatus(S, "Output 5: the current width is < 1"); return; }
    ...
    {
        int_T y6Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "IMP_CreateDriverInfoResponseDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_OutputDriverInfoResponseDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_DeleteDriverInfoResponseDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_CreateDriverInfoResponseDecode_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_OutputDriverInfoResponseDecode_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_DeleteDriverInfoResponseDecode_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    IMP_CreateDriverInfoResponseDecode();
}
#endif
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T* y5 = (uint8_T*) ssGetOutputPortSignal(S, 4);
    uint8_T* y6 = (uint8_T*) ssGetOutputPortSignal(S, 5);
    uint32_T* p1 = (uint32_T*) ssGetRunTimeParamInfo(S, 0)->data;


    /* Call the legacy code function */
    IMP_OutputDriverInfoResponseDecode(u1, *u2, y1, y2, y3, y4, y5, y6, *p1);
}
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    IMP_DeleteDriverInfoResponseDecode();
}
