/**
 * SFunctionIMPDriverConvexPolygonDecode.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void IMP_OutputDriverConvexPolygonDecode(uint8 u1[], uint32 u2, int32 y1[1], double y2[1], uint8 y3[1], uint8 y4[1], double y5[3], double y6[2*255*p1], uint16 p1, uint8 y7[p1], uint16 y8[p1], uint8 y9[p1], double y10[p1], double y11[p1], double y12[p1], uint16 y13[1])
 *
...
#define S_FUNCTION_NAME  SFunctionIMPDriverConvexPolygonDecode
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T y6Width = 2*255*(int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y6Width!=DYNAMICALLY_SIZED && y6Width < 1) { ssSetErrorStatus(S, "Output 6: the current width is < 1"); return; }
    ...
    {
        int_T y7Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y7Width!=DYNAMICALLY_SIZED && y7Width < 1) { ssSetErrorStatus(S, "Output 7: the current width is < 1"); return; }
    ...
    {
        int_T y8Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y8Width!=DYNAMICALLY_SIZED && y8Width < 1) { ssSetErrorStatus(S, "Output 8: the current width is < 1"); return; }
    ...
    {
        int_T y9Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y9Width!=DYNAMICALLY_SIZED && y9Width < 1) { ssSetErrorStatus(S, "Output 9: the current width is < 1"); return; }
    ...
    {
        int_T y10Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y10Width!=DYNAMICALLY_SIZED && y10Width < 1) { ssSetErrorStatus(S, "Output 10: the current width is < 1"); return; }
    ...
    {
        int_T y11Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y11Width!=DYNAMICALLY_SIZED && y11Width < 1) { ssSetErrorStatus(S, "Output 11: the current width is < 1"); return; }
    ...
    {
        int_T y12Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 0));
        if (y12Width!=DYNAMICALLY_SIZED && y12Width < 1) { ssSetErrorStatus(S, "Output 12: the current width is < 1"); return; }
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "IMP_CreateDriverConvexPolygonDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_OutputDriverConvexPolygonDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_DeleteDriverConvexPolygonDecode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_CreateDriverConvexPolygonDecode_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_OutputDriverConvexPolygonDecode_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_DeleteDriverConvexPolygonDecode_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    uint8_T* y7 = (uint8_T*) ssGetOutputPortSignal(S, 6);
    uint16_T* y8 = (uint16_T*) ssGetOutputPortSignal(S, 7);
    uint8_T* y9 = (uint8_T*) ssGetOutputPortSignal(S, 8);
    ...
    uint16_T* y13 = (uint16_T*) ssGetOutputPortSignal(S, 12);


    /* Call the legacy code function */
    IMP_OutputDriverConvexPolygonDecode(u1, *u2, y1, y2, y3, y4, y5, y6, *p1, y7, y8, y9, y10, y11, y12, y13);
}
