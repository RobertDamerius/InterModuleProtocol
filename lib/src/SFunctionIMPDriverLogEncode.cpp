/**
 * SFunctionIMPDriverLogEncode.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void IMP_OutputDriverLogEncode(uint8 y1[p1], uint32 y2[1], uint32 p1, double u1, uint8 u2[3], uint8 u3[p2], uint32 p2, uint32 u4)
 *
...
#define S_FUNCTION_NAME  SFunctionIMPDriverLogEncode
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    {
        int_T u3Width = (int_T)mxGetScalar(ssGetSFcnParam(S, 1));
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "IMP_CreateDriverLogEncode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_OutputDriverLogEncode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "IMP_DeleteDriverLogEncode", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_CreateDriverLogEncode_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_OutputDriverLogEncode_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "IMP_DeleteDriverLogEncode_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    IMP_OutputDriverLogEncode(y1, y2, *p1, *u1, u2, u3, *p2, *u4);
}
